        ...
        <div className="container mt-5">
            <div className="row">
                ...
                <div className="col-md-4 text-left">
                    <img src="https://dthezntil550i.cloudfront.net/f4/latest/f41908291942413280009640715/1280_960/1b2d9510-d66d-43a2-971a-cfcbb600e7fe.png" alt="Profile" className="img-fluid rounded-circle mb-3" style={{ maxHeight: '100px' }} />
                </div>
            </div>
